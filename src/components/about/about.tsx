...
function About() {
    return (
        <section className="w-full min-h-[80vh] flex items-center justify-center border-[1px] border-gray-100 mt-5  rounded-xl">
            <div className='lg:w-[80%] min-h-[70vh] flex items-center lg:flex-row flex-col px-4 p-3  shadow-lg rounded-xl '>
                ...
                <div className='lg:w-[50%] w-full h-[60vh] rounded-xl p-4 flex items-center justify-center flex-col'>
